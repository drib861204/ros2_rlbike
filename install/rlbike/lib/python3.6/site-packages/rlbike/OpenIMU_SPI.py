...
if __name__ == "__main__":       
    ...
    openimu_spi = SpiOpenIMU(target_module="300ZI",drdy_status=True, fw='26.0.7', cs_pin = 19, interrupt_pin = 26)   #set the module name and drdy status(enalbe or not)-----------------step: 1
